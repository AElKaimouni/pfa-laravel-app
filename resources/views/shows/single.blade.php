					...
					<div class="movie-btn">	
                        ...
                        @if($user && $user->hasValidSubscription())
                            <div class="btn-transform transform-vertical">
                                <div><a href="#" class="item item-1 redbtn"> <i class="ion-play"></i> Watch Now</a></div>
                        ...
                        @else
                            ...
                            <div class="btn-transform transform-vertical">
                                <div><a href="/subscription" class="item item-1 yellowbtn"> <i class="ion-card"></i> Buy ticket</a></div>
